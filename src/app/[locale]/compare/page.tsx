...
import { ProvinceCompare } from '@/components/calculator/province-compare';
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      ...
      languages: { en: `${baseUrl}/en/compare`, fr: `${baseUrl}/fr/compare` },
    },
  };
}
    ...
    <>
      ...
      <JsonLd
        data={breadcrumbSchema(locale, [
          ...
          { name: t('compare.title'), url: `/${locale}/compare` },
        ])}
      />
